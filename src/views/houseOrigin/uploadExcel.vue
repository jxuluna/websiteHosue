      ...
      <div>
        ...
        <div class="importText">
          ...
          <span class="downUpload">
            <a href="https://hihome2019.oss-cn-beijing.aliyuncs.com/%E6%88%BF%E6%BA%90%E6%A8%A1%E6%9D%BF.xlsx" style="color: #306cff;text-decoration: underline;">
            下载模板
            </a>
            </span>
        </div>
...
export default {
  ...
  methods: {
    ...
    uploadSectionFile: function(param) {
      ...
      // 接收上传文件的后台地址
      var FileController =
        "https://apps.hailuojia.com/admin/uploadhouse/batch";
      // FormData 对象
